...
export default function Register() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log(`Submitting ${role} Registration:`, formData);
  };
        ...
        <div className="flex-1 px-8 py-6 flex flex-col justify-between h-full overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col flex-1 justify-between overflow-hidden">
            ...
            <div className="pt-2">
              <button
                type="submit"
                className="w-full py-2 px-4 bg-[#006948] hover:bg-[#005238] text-white text-xs font-semibold rounded-lg shadow-sm transition-colors cursor-pointer"
              >
                Sign Up
              </button>
